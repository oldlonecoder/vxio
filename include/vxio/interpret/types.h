...
constexpr T        number_t       = 0x000000001;
constexpr T        text_t         = 0x000000002;
constexpr T        void_ptr       = 0x000000004;
constexpr T        any_t          = 0x000000008;
constexpr T        leaf_t         = 0x000000010;
constexpr T        sign_t         = 0x000000020;
constexpr T        i8_t           = 0x000000040;
constexpr T        i16_t          = 0x000000080; // 0x7F41
constexpr T        i32_t          = 0x000000100;
constexpr T        i64_t          = 0x000000200;
constexpr T        u8_t           = 0x000000400;
constexpr T        u16_t          = 0x000000800;
constexpr T        u32_t          = 0x000001000;
constexpr T        u64_t          = 0x000002000;
constexpr T        float_t        = 0x000004000; // real: f32, f64, f128... ^^
constexpr T        var_t          = 0x000008000; // Ne pas oublier d'ajouter ce type a toutes "variables"
constexpr T        bloc_t         = 0x000010000;
constexpr T        pipe_t         = 0x000020000;
constexpr T        keyword_t      = 0x000040000;
constexpr T        unary_t        = 0x000080000;
constexpr T        prefix_t       = 0x000100000;
constexpr T        postfix_t      = 0x000200000;
constexpr T        operator_t     = 0x000400000;
constexpr T        binary_t       = 0x000800000;
constexpr T        function_t     = 0x001000000;
constexpr T        function_ptr   = 0x002000000;
constexpr T        object_t       = 0x004000000;
constexpr T        pointer_t      = 0x008000000;
constexpr T        type_t         = 0x010000000;
constexpr T        id_t           = 0x020000000;
constexpr T        ref_t          = 0x040000000;
constexpr T        punc_t         = 0x080000000;
constexpr T        assign_t       = 0x100000000;
constexpr T        bool_t         = 0x200000000;
constexpr T        hex_t          = 0x400000000;
constexpr T        open_pair_t    = 0x800000000;
constexpr T        close_pair_t   = 0x1000000000;
//constexpr T k_open_abs_op = 0x2000000000;
//constexpr T k_close_abs_op = 0x4000000000;
constexpr T        static_t       = 0x8000000000; ///< Flag set at the parser phase when applicable.
constexpr T        f32_t          = 0x10000000000;
constexpr T        f64_t          = 0x20000000000;
constexpr T        f128_t         = 0x40000000000;
constexpr T        octal_format_t = 0x80000000000;
