...
#   ifdef VXIO_UTIL_DLL_EXPORT
#       define VXIO_UTIL_DLL __declspec(dllexport)
#       if __GNUC__ >= 4
#           define VXIO_UTIL_DLL __attribute__ ((visibility ("default")))
#           define PRIVATE_LIB  __attribute__ ((visibility ("hidden")))
//#       else
//#           define VXIO_UTIL_DLL
//#           define PRIVATE_LIB
#       endif
#   else
#       define VXIO_UTIL_DLL __declspec(dllimport)
#   endif
#   else
#       define VXIO_UTIL_DLL    // Not ms-Windows/MSVC
#endif
