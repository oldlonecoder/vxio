...
#   ifdef CONIO_DLL_EXPORT
#       define CONIO_DLL __declspec(dllexport)
#       if __GNUC__ >= 4
#           define CONIO_DLL __attribute__ ((visibility ("default")))
...
#       endif
#   else
#       define CONIO_DLL __declspec(dllimport)
#   endif
#   else
#       define CONIO_DLL    // Not ms-Windows/MSVC
#endif
