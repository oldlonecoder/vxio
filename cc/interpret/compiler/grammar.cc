...
grammar::term::term(vxio::type::T a_sem, grammar::term_properties a_)
{
    a = a_;
    object.sem = a_sem;
    _type = term::type::s;
...
grammar::rule &grammar::rule::operator|(vxio::type::T _t)
{
    term t = term(_t);
    t.a = a;
    a.Reset();
...
grammar::term_seq &grammar::term_seq::operator<<(vxio::type::T a_t)
{
